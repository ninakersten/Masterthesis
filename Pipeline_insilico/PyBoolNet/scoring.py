...
with open("./goldstandard/SC1AaggregateSubmission-MCF7-FGF1-Network.sif","r") as fin, open ("./goldstandard/Gold_MCF7_FGF1_1.sif","w") as fout:
	for line in fin:
		fout.write(line.replace('\t',' '))
#print(fout)

#Read in the Golstandard and the Prediction data set
gold_file = open("./goldstandard/Gold_MCF7_FGF1_1.sif","r")
pred_file = open("./SIF_files/Pred_MCF7_mainFGF1.sif","r")
