...
\usepackage{subfigure}				% Lässt Bilder nebeneinander darstellen
\usepackage{varwidth}
...
\mainmatter 							% die einzelnen Kapitel
    ...
    \input{./Kapitel/materialsandmethods}
    \clearpage{\pagestyle{empty}\cleardoublepage}
    \input{./Kapitel/applicationOfThePipeline}
    \clearpage{\pagestyle{empty}\cleardoublepage}
...
% -----------------------------------
%\backmatter 
\bibliographystyle{abbrv}				% bei natbib in deutsch
